...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/gabbiewink/esp/robot/src/build/bootloader/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	python /home/gabbiewink/esp/esp-idf/components/esptool_py/esptool/esptool.py --chip esp32 elf2image --flash_mode dio --flash_freq 40m --flash_size 2MB -o /home/gabbiewink/esp/robot/src/build/bootloader/bootloader.bin bootloader.elf
	/usr/bin/cmake -E echo "Generated /home/gabbiewink/esp/robot/src/build/bootloader/bootloader.bin"
	/usr/bin/cmake -E md5sum /home/gabbiewink/esp/robot/src/build/bootloader/bootloader.bin > /home/gabbiewink/esp/robot/src/build/bootloader/.bin_timestamp
